      ...
      >
        <Form layout="vertical" onFinish={onFinish} form={formRef}>
          ...
          <Form.Item
            ...
            label="Distand_from_city(Km)"
            validateStatus={validate.distand_from_city ? "error" : ""}
            help={validate.distand_from_city?.[0]}
            rules={[
              {
                required: true,
                message: "Field distand_from_city required",
              },
            ]}
          >
            <Input placeholder="Distand_from_city" />
          </Form.Item>
          <Form.Item
            name="status"
            label="Role Status"
